  ...
  return (
    <>
      <div className='flex mt-16 xl:mt-0  flex-1 flex-col  justify-center lg:items-start items-center ml-0  xl:ml-32 relative'>
        <div className='lg:hidden  flex h-[15%] relative -top-[50px] bg-dark_range w-full mb-10 -mt-6 items-center justify-center space-x-3 '>
          <div className=' w-12 h-14 flex items-center'>
            <img src={CompanyLogo} alt='company-logo' />
          </div>
          <span className='font-bold text-base_range text-2xl'>LODLC</span>
        </div>
